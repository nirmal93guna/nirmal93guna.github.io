...
function runAnimationLoop(){
  ...
  creative.MainTimeline
    ...
    .set( creative.dom.cursor, {left: 10}, 'letterone')
    ...
    .to(creative.dom.email.left, 1, {left:40, ease: Power3.easeIn, delay:0.8},'slide-one')
    .to(creative.dom.email.right, 1, {left:240, ease: Power3.easeIn, delay:0.8},'slide-one')
    .to(creative.dom.whiteBg, 1,{left:310, ease: Power3.easeIn, delay:0.8},'slide-one' )
    ...
    .to( creative.dom.bgImg, 1, {left: -522, ease: Power3.easeIn, delay:1},'slide-two')
